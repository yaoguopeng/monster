...
Source Database       : green_light

Target Server Type    : MYSQL
Target Server Version : 50717
File Encoding         : 65001

Date: 2019-08-20 16:14:48
*/
...
CREATE TABLE `t_island_background` (
  ...
  `is_deleted` int(2) DEFAULT '0' COMMENT '是否删除：1是0否',
  PRIMARY KEY (`pk_id`)
...
CREATE TABLE `t_island_message` (
  ...
  `is_deleted` int(2) DEFAULT '0' COMMENT '是否已删除1是0否',
  PRIMARY KEY (`pk_id`)
...
CREATE TABLE `t_island_poem` (
  ...
  `poem_explaination` varchar(3000) DEFAULT NULL COMMENT '诗歌解释',
...
CREATE TABLE `t_island_post` (
  ...
  `is_deleted` int(2) DEFAULT '0' COMMENT '是否已删除1是0否,默认0',
  PRIMARY KEY (`pk_id`)
...
-- ----------------------------
-- Table structure for t_island_post_likes
-- ----------------------------
DROP TABLE IF EXISTS `t_island_post_likes`;
CREATE TABLE `t_island_post_likes` (
  `pk_id` varchar(36) NOT NULL DEFAULT '' COMMENT '主键',
  `post_id` varchar(36) DEFAULT NULL COMMENT '帖子唯一标识',
  `like_user_id` varchar(50) DEFAULT NULL COMMENT '点赞者unionid',
  `created_time` datetime DEFAULT NULL COMMENT '点赞时间',
  PRIMARY KEY (`pk_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='【时光小岛】点赞帖子';

-- ----------------------------
-- Records of t_island_post_likes
-- ----------------------------
...
CREATE TABLE `t_island_topic` (
  ...
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `is_deleted` int(2) DEFAULT '0' COMMENT '是否已删除1是0否，默认0',
  `audit_status` int(2) DEFAULT '0' COMMENT '是否审核通过1是0否，默认0',
  PRIMARY KEY (`pk_id`)
...
CREATE TABLE `t_island_visitor` (
  ...
  PRIMARY KEY (`pk_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='小程序【时光小岛】的用户表';
...
INSERT INTO `t_island_visitor` VALUES ('2', 'owCIF1YaOmfvlodwsNh0Ex5L6Ne8', '2019-04-12 16:01:16', '　　　　　　', '2019-04-12 16:59:36', '3', 'https://wx.qlogo.cn/mmopen/vi_32/PiajxSqBRaEKOu2Tc6mQU2G0r4hXDWV78VJ9IicXdAtd9KK2gFOKyHmbNpN2KyrwQsqIALVFaOltUla4NNtibUBicw/132', null, '1', 'zh_CN', 'Hangzhou', 'Zhejiang', 'China');
...
CREATE TABLE `t_visitor_dialogue` (
  ...
  `is_read` int(2) DEFAULT '0' COMMENT '是否已读：1是，0否',
  `is_deleted` int(2) DEFAULT '0' COMMENT '是否已删除：1是0否',
  PRIMARY KEY (`pk_id`)
...
CREATE TABLE `t_visitor_storehouse` (
  ...
  `stored_cancel` int(2) DEFAULT '0' COMMENT '是否取消：1是0否',
...
-- ----------------------------
INSERT INTO `t_visitor_storehouse` VALUES ('01efbb3c-4da3-4937-9ad0-42c2878e9716', 'owCIF1YaOmfvlodwsNh0Ex5L6Ne8', '3', 'MOVIE', '2019-04-12 17:52:56', '0', null);
INSERT INTO `t_visitor_storehouse` VALUES ('1', '1', '1', 'MOVIE', '2019-04-12 16:59:23', '0', '2019-04-01 16:59:44');
INSERT INTO `t_visitor_storehouse` VALUES ('5fcb1651-d29d-42dc-b66e-4d8f617871b3', 'owCIF1YaOmfvlodwsNh0Ex5L6Ne8', '7', 'MOVIE', '2019-04-12 17:28:06', '0', null);
INSERT INTO `t_visitor_storehouse` VALUES ('6f216ff4-7017-42ad-9400-dab9fd5278a1', '1', '3', 'MOVIE', '2019-04-12 17:14:56', '0', null);
INSERT INTO `t_visitor_storehouse` VALUES ('edca60a0-8dce-4a07-8431-81e9e5d49af0', 'owCIF1YaOmfvlodwsNh0Ex5L6Ne8', '1', 'MOVIE', '2019-04-12 17:28:54', '0', null);
